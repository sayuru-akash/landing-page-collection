    ...
    <section aria-labelledby="verticals-heading">
      <div className="max-inline-size-container-wide">
        <div className="ResourcesSection_intro__sudFO">
          <div>
            <h2 className="visually-hidden" id="verticals-heading">
              Whoever you are, we’ve got you covered
            </h2>
            <p className="text-heading ResourcesSection_heading__7qXmw">
              Whoever you are, we’ve got you covered
            </p>
          </div>
        </div>
        ...
        <div className="VerticalsSection_content__ehRdn" data-theme={content.theme}>
            ...
            <div className="VerticalsSection_communityMembers__moTcS">
              {content.people.map((person) => (
                <div className="VerticalsSection_communityMember__jfNSG" key={person.name}>
                  ...
                  <h5 className="visually-hidden">{person.name}</h5>
                  <dl className="VerticalsSection_communityMemberDetails__b1xIl">
                    <div>
                      <dt className="visually-hidden">Username</dt>
                      <dd className="text-heading VerticalsSection_communityMemberUsername__TMlv_">
                        {person.username}
                      </dd>
                    </div>
                    <div>
                      <dt className="visually-hidden">Followers</dt>
                      <dd className="VerticalsSection_communityMemberFollowers__K3HoJ">
                        {person.followers}
                      </dd>
                    </div>
                  </dl>
